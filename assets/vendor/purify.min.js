...
addEventListener('load', () => {
    ...
    //All type="text"
    let inputsApp = document.querySelectorAll('input[type="text"]');
    ...
    //All type="search"
    let inputsSearchApp = document.querySelectorAll('input[type="search"]');
    inputsSearchApp.forEach( item => {
        item.addEventListener("change", (e) => {
            const result = sanitize(e.target.value)
            //console.log(result)
        })
    ...
    //All textarea
    let textareaApp = document.querySelectorAll('textarea');
    textareaApp.forEach( item => {
        item.addEventListener("change", (e) => {
            const result = sanitize(e.target.value)
            //console.log(result)
        })
